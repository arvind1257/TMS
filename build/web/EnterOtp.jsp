        ...
        <section>
            <div class="main">
                ...
                <div class="rightIndex">
                    <form id="myform" action="ValidateOtp" autocomplete="off" method="post"></form>
                    <div ><img class="bgright" src="bgright.jpeg" alt="no img" width="100%"/></div>
                    <div class="bg">
                        <h1 style="text-align: center;">OTP Verification</h1>
                        <br>
                        <h3>Enter the OTP : </h3>
                        <h4>(An OTP is sent to your registered <br>mail id)</h4>
                        <div class="login__field">
                            <i class = "login__icon fas fa-user"> </i> 
                            <input form="myform" value="" class="login__input" type="text" id="username" name="otp" placeholder="OTP" required/>
                        </div>
